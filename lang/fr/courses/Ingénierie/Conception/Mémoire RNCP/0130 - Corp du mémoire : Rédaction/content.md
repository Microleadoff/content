Rendu à cette étape, vous devriez normalement avoir finalisé l'organisation du contenu de votre mémoire. Il est donc temps d'attaquer la rédaction, pour transformer les listes et sous-listes en texte !
